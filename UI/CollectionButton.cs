...
namespace SpikersArchipelago.UI
{
    class CollectionButton : UIElement
    {
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            if (Clickable)
            {
                spriteBatch.Draw((Texture2D)ModContent.Request<Texture2D>(hovered ? "SpikersArchipelago/UI/CollectionButtonHover" : "SpikersArchipelago/UI/CollectionButton"), new Vector2(left, top), new Color(255, 255, 255));
                if (hovered)
                {
