    ...
    public class SpikersArchipelago : Mod
    {
        ...
        public override void Load()
        {
            ...
            On_WorldGen.IsRoomConsideredAlreadyOccupied += (On_WorldGen.orig_IsRoomConsideredAlreadyOccupied orig, int i, int j, int type) =>
            {
                ...
                {
                    if (ghost.NPC.active && ghost.NPC.homeTileX == i && ghost.NPC.homeTileY == j)
                        return true;
                }
            ...
            IL_Main.UpdateTime_SpawnTownNPCs += il =>
            {
                ...
                cursor.EmitDelegate(() =>
                {
                    if (archipelagoSystem.session is null)
                        return NPC.downedBoss3 || NPC.AnyNPCs(NPCID.OldMan);
            ...
            Terraria.IL_NPC.AI_000_TransformBoundNPC += il =>
            {
                ...
                cursor.EmitDelegate((int npcType) =>
                {
                    ...
                    {
                        case NPCID.Angler:
                            boundNPCtype = NPCID.SleepingAngler;
                            locName = "Angler";
                            NPC.savedAngler = true;
                            break;
                        case NPCID.Golfer:
                            boundNPCtype = NPCID.GolferRescue;
                            locName = "Golfer";
                            NPC.savedGolfer = true;
                            break;
                        case NPCID.DD2Bartender:
                            boundNPCtype = NPCID.BartenderUnconscious;
                            locName = "Tavernkeep";
                            NPC.savedBartender = true;
                            break;
                        case NPCID.Stylist:
                            boundNPCtype = NPCID.WebbedStylist;
                            locName = "Stylist";
                            NPC.savedStylist = true;
                            break;
                        case NPCID.GoblinTinkerer:
                            boundNPCtype = NPCID.BoundGoblin;
                            locName = "Goblin Tinkerer";
                            NPC.savedGoblin = true;
                            break;
                        case NPCID.Mechanic:
                            boundNPCtype = NPCID.BoundMechanic;
                            locName = "Mechanic";
                            NPC.savedMech = true;
                            break;
                        case NPCID.Wizard:
                            boundNPCtype = NPCID.BoundWizard;
                            locName = "Wizard";
                            NPC.savedWizard = true;
                            break;
                        default:
                            throw new Exception($"NPC type {npcType} unaccounted for in TransformBoundNPC");
                    }
                    if (!archipelagoSystem.world.randomizedNPCs.Contains(npcType))
                        return npcType;
            ...
            IL_NPC.SetEventFlagCleared += il =>
            {
                ...
                cursor.EmitDelegate((int id) =>
                {
                    ...
                    if (location != null)
                        archipelagoSystem.QueueLocation(location);
                });
                cursor.Emit(OpCodes.Ret);
            };
            ...
            foreach (var type in calamityAssembly.GetTypes())
                switch (type.Name)
                {
                    case "DesertScourgeHead":
                        desertScourgeHeadOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "GiantClam":
                        giantClamOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "CragmawMire":
                        cragmawMireOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "AcidRainEvent":
                        acidRainEventUpdateInvasion = type.GetMethod("UpdateInvasion", BindingFlags.Static | BindingFlags.Public);
                        break;
                    case "Crabulon":
                        crabulonOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "HiveMind":
                        hiveMindOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "PerforatorHive":
                        perforatorHiveOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "SlimeGodCore":
                        slimeGodCoreOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    ...
                    case "AquaticScourgeHead":
                        aquaticScourgeHeadOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "Mauler":
                        maulerOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "BrimstoneElemental":
                        brimstoneElementalOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "Cryogen":
                        cryogenOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "CalamitasClone":
                        calamitasCloneOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "GreatSandShark":
                        greatSandSharkOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "Leviathan":
                        leviathanRealOnKill = type.GetMethod("RealOnKill", BindingFlags.Static | BindingFlags.Public);
                        break;
                    case "AstrumAureus":
                        astrumAureusOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "PlaguebringerGoliath":
                        plaguebringerGoliathOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "RavagerBody":
                        ravagerBodyOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "AstrumDeusHead":
                        astrumDeusHeadOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "ProfanedGuardianCommander":
                        profanedGuardianCommanderOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "Bumblefuck":
                        bumblefuckOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "Providence":
                        providenceOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "StormWeaverHead":
                        stormWeaverHeadOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "CeaselessVoid":
                        ceaselessVoidOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "Signus":
                        signusOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "Polterghast":
                        polterghastOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "NuclearTerror":
                        nuclearTerrorOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "OldDuke":
                        oldDukeOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "DevourerofGodsHead":
                        devourerofGodsHeadOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "Yharon":
                        yharonOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "AresBody":
                        aresBodyOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "Apollo":
                        apolloOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "ThanatosHead":
                        thanatosHeadOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                    case "SupremeCalamitas":
                        supremeCalamitasOnKill = type.GetMethod("OnKill", BindingFlags.Instance | BindingFlags.Public);
                        break;
                }
        ...
        public override void HandlePacket(BinaryReader reader, int whoAmI)
        {
            ...
            if (message == "")
                ...
                archipelagoSystem.TriggerDeathlink(message.Substring(9), whoAmI);
            else if (message.StartsWith("[DeathLink]"))
            {
            ...
            else if (message == "YouGotAnItem")
                Main.LocalPlayer.GetModPlayer<ArchipelagoPlayer>().ReceivedReward(reader.ReadInt32());
        ...
        void OnAchievementCompleted(Achievement achievement)
        {
            ...
            if (name != null)
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocationClient(name);
        ...
        void OnDesertScourgeHeadOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Desert Scourge");
        }
        ...
        void OnGiantClamOnKill(OnKill orig, ModNPC self)
        {
            ...
            else
            {
                ...
                if (Main.hardMode)
                    ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Hardmode Giant Clam");
            }
        }
        ...
        void OnCragmawMireOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Cragmaw Mire");
        }
        ...
        void EditAcidRainEventUpdateInvasion(ILContext il)
        {
            ...
            cursor.EmitDelegate<Action<bool>>(won =>
            {
                if (won)
                {
                    ...
                    if (calamitySystem.DownedAquaticScourge())
                        archipelagoSystem.QueueLocation("Acid Rain Tier 2");
                }
            });
            cursor.Emit(OpCodes.Ldc_I4_0);
        }
        ...
        void OnCrabulonOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Crabulon");
        }
        ...
        void OnHiveMindOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("The Hive Mind");
        }
        ...
        void OnPerforatorHiveOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("The Perforators");
        }
        ...
        void OnSlimeGodCoreOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("The Slime God");
        }
        ...
        {
            if (temp || !vanillaBosses.Contains(npc.type))
                orig(self, npc);
            else
                ModContent.GetInstance<CalamitySystem>().HandleBossRush(npc);
        }
        ...
        void OnAquaticScourgeHeadOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Aquatic Scourge");
        }
        ...
        void OnMaulerOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Mauler");
        }
        ...
        void OnBrimstoneElementalOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Brimstone Elemental");
        }
        ...
        void OnCryogenOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Cryogen");
        }
        ...
        void OnCalamitasCloneOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Calamitas Clone");
        }
        ...
        void OnGreatSandSharkOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Great Sand Shark");
        }
        ...
        void OnLeviathanRealOnKill(RealOnKill orig, NPC npc)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Leviathan and Anahita");
        }
        ...
        void OnAstrumAureusOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Astrum Aureus");
        }
        ...
        void OnPlaguebringerGoliathOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("The Plaguebringer Goliath");
        }
        ...
        void OnRavagerBodyOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Ravager");
        }
        ...
        void OnAstrumDeusHeadOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Astrum Deus");
        }
        ...
        void OnProfanedGuardianCommanderOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Profaned Guardians");
        }
        ...
        void OnBumblefuckOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("The Dragonfolly");
        }
        ...
        void OnProvidenceOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Providence, the Profaned Goddess");
        }
        ...
        void OnStormWeaverHeadOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Storm Weaver");
        }
        ...
        void OnCeaselessVoidOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Ceaseless Void");
        }
        ...
        void OnSignusOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Signus, Envoy of the Devourer");
        }
        ...
        void OnPolterghastOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Polterghast");
        }
        ...
        void OnNuclearTerrorOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Nuclear Terror");
        }
        ...
        void OnOldDukeOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("The Old Duke");
        }
        ...
        void OnDevourerofGodsHeadOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("The Devourer of Gods");
        }
        ...
        void OnYharonOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Yharon, Dragon of Rebirth");
        }
        ...
        void OnAresBodyOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                orig(self);
            else if (ModContent.GetInstance<CalamitySystem>().AreExosDead(0))
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Exo Mechs");
        }
        ...
        void OnApolloOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                orig(self);
            else if (ModContent.GetInstance<CalamitySystem>().AreExosDead(1))
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Exo Mechs");
        }
        ...
        void OnThanatosHeadOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                orig(self);
            else if (ModContent.GetInstance<CalamitySystem>().AreExosDead(2))
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Exo Mechs");
        }
        ...
        void OnSupremeCalamitasOnKill(OnKill orig, ModNPC self)
        {
            if (temp)
                ...
                ModContent.GetInstance<ArchipelagoSystem>().QueueLocation("Supreme Witch, Calamitas");
        }
