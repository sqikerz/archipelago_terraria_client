...
namespace SpikersArchipelago.Systems
{
    ...
    public class CalamitySystem : ModSystem
    {
        ...
        {
            if (CalamityMod.DownedBossSystem.downedBossRush)
        ...
        {
            if (CalamityServerConfig.Instance.EarlyHardmodeProgressionRework && NPC.downedMechBoss1 && NPC.downedMechBoss2 && NPC.downedMechBoss3)
                SpawnMechOres();
        }
        ...
        public void VanillaBossKilled(int boss)
        {
            ...
            var spikersArchipelago = ModContent.GetInstance<SpikersArchipelago>();
            spikersArchipelago.temp = true;
            calamityNpc.OnKill(npc);
            spikersArchipelago.temp = false;
        }
        ...
        public void CalamityOnKillGiantClam(bool hardmode)
        {
            ...
            CalamityOnKill<CalamityMod.NPCs.SunkenSea.GiantClam>(SpikersArchipelago.giantClamOnKill);
            if (hardmode)
                CalamityMod.DownedBossSystem.downedCLAM = downed;
            else
                CalamityMod.DownedBossSystem.downedCLAMHardMode = downed;
        ...
        public void CalamityOnKillLeviathanAndAnahita()
        {
            var spikersArchipelago = ModContent.GetInstance<SpikersArchipelago>();
            spikersArchipelago.temp = true;
            SpikersArchipelago.leviathanRealOnKill.Invoke(new CalamityMod.NPCs.Leviathan.Leviathan(), new object[] { null });
            spikersArchipelago.temp = false;
        }

        public void CalamityOnKillCryogen()
        {
            CalamityOnKill<CalamityMod.NPCs.Cryogen.Cryogen>(SpikersArchipelago.cryogenOnKill);
            if (Main.netMode == NetmodeID.SinglePlayer)
                CalamityUtils.SpawnOre(ModContent.TileType<CryonicOre>(), 0.00015, 0.45f, 0.7f, 3, 8, new int[] {
                147,
                161,
                163,
                200,
        ...
        public void CalamityOnKillDesertScourge() => CalamityOnKill<CalamityMod.NPCs.DesertScourge.DesertScourgeHead>(SpikersArchipelago.desertScourgeHeadOnKill);
        public void CalamityOnKillCrabulon() => CalamityOnKill<CalamityMod.NPCs.Crabulon.Crabulon>(SpikersArchipelago.crabulonOnKill);
        public void CalamityOnKillTheHiveMind() => CalamityOnKill<CalamityMod.NPCs.HiveMind.HiveMind>(SpikersArchipelago.hiveMindOnKill);
        public void CalamityOnKillThePerforators() => CalamityOnKill<CalamityMod.NPCs.Perforator.PerforatorHive>(SpikersArchipelago.perforatorHiveOnKill);
        public void CalamityOnKillTheSlimeGod() => CalamityOnKill<CalamityMod.NPCs.SlimeGod.SlimeGodCore>(SpikersArchipelago.slimeGodCoreOnKill);
        public void CalamityOnKillAquaticScourge() => CalamityOnKill<CalamityMod.NPCs.AquaticScourge.AquaticScourgeHead>(SpikersArchipelago.aquaticScourgeHeadOnKill);
        public void CalamityOnKillCragmawMire() => CalamityOnKill<CalamityMod.NPCs.AcidRain.CragmawMire>(SpikersArchipelago.cragmawMireOnKill);
        public void CalamityOnKillBrimstoneElemental() => CalamityOnKill<CalamityMod.NPCs.BrimstoneElemental.BrimstoneElemental>(SpikersArchipelago.brimstoneElementalOnKill);
        public void CalamityOnKillCalamitasClone() => CalamityOnKill<CalamityMod.NPCs.CalClone.CalamitasClone>(SpikersArchipelago.calamitasCloneOnKill);
        public void CalamityOnKillGreatSandShark() => CalamityOnKill<CalamityMod.NPCs.GreatSandShark.GreatSandShark>(SpikersArchipelago.greatSandSharkOnKill);
        public void CalamityOnKillAstrumAureus() => CalamityOnKill<CalamityMod.NPCs.AstrumAureus.AstrumAureus>(SpikersArchipelago.astrumAureusOnKill);
        public void CalamityOnKillThePlaguebringerGoliath() => CalamityOnKill<CalamityMod.NPCs.PlaguebringerGoliath.PlaguebringerGoliath>(SpikersArchipelago.plaguebringerGoliathOnKill);
        public void CalamityOnKillRavager() => CalamityOnKill<CalamityMod.NPCs.Ravager.RavagerBody>(SpikersArchipelago.ravagerBodyOnKill);
        public void CalamityOnKillAstrumDeus() => CalamityOnKill<CalamityMod.NPCs.AstrumDeus.AstrumDeusHead>(SpikersArchipelago.astrumDeusHeadOnKill, new float[] { 3, 0, 0, 0 });
        public void CalamityOnKillProfanedGuardians() => CalamityOnKill<CalamityMod.NPCs.ProfanedGuardians.ProfanedGuardianCommander>(SpikersArchipelago.profanedGuardianCommanderOnKill);
        public void CalamityOnKillTheDragonfolly() => CalamityOnKill<CalamityMod.NPCs.Bumblebirb.Bumblefuck>(SpikersArchipelago.bumblefuckOnKill);
        public void CalamityOnKillProvidenceTheProfanedGoddess() => CalamityOnKill<CalamityMod.NPCs.Providence.Providence>(SpikersArchipelago.providenceOnKill);
        public void CalamityOnKillStormWeaver() => CalamityOnKill<CalamityMod.NPCs.StormWeaver.StormWeaverHead>(SpikersArchipelago.stormWeaverHeadOnKill);
        public void CalamityOnKillCeaselessVoid() => CalamityOnKill<CalamityMod.NPCs.CeaselessVoid.CeaselessVoid>(SpikersArchipelago.ceaselessVoidOnKill);
        public void CalamityOnKillSignusEnvoyOfTheDevourer() => CalamityOnKill<CalamityMod.NPCs.Signus.Signus>(SpikersArchipelago.signusOnKill);
        public void CalamityOnKillPolterghast() => CalamityOnKill<CalamityMod.NPCs.Polterghast.Polterghast>(SpikersArchipelago.polterghastOnKill);
        public void CalamityOnKillMauler() => CalamityOnKill<CalamityMod.NPCs.AcidRain.Mauler>(SpikersArchipelago.maulerOnKill);
        public void CalamityOnKillNuclearTerror() => CalamityOnKill<CalamityMod.NPCs.AcidRain.NuclearTerror>(SpikersArchipelago.nuclearTerrorOnKill);
        public void CalamityOnKillTheOldDuke() => CalamityOnKill<CalamityMod.NPCs.OldDuke.OldDuke>(SpikersArchipelago.oldDukeOnKill);
        public void CalamityOnKillTheDevourerOfGods() => CalamityOnKill<CalamityMod.NPCs.DevourerofGods.DevourerofGodsHead>(SpikersArchipelago.devourerofGodsHeadOnKill);
        public void CalamityOnKillYharonDragonOfRebirth() => CalamityOnKill<CalamityMod.NPCs.Yharon.Yharon>(SpikersArchipelago.yharonOnKill);
        public void CalamityOnKillSupremeWitchCalamitas() => CalamityOnKill<CalamityMod.NPCs.SupremeCalamitas.SupremeCalamitas>(SpikersArchipelago.supremeCalamitasOnKill);

        public void SpawnHardOres()
        {
            if (!CalamityMod.CalamityServerConfig.Instance.EarlyHardmodeProgressionRework)
                return;
        ...
        public void HandleBossRush(NPC npc)
        {
            if (BossRushEvent.BossRushActive)
                typeof(BossRushEvent).GetMethod("OnBossKill", BindingFlags.NonPublic | BindingFlags.Static).Invoke(null, new object[] { npc, ModContent.GetInstance<CalamityMod.CalamityMod>() });
        }
    }
}
